...
export default function AdminProfile() {
  ...
  async function handlePhoneUpdate(e: React.FormEvent) {
    ...
    try {
      ...
      // Update phone in UI for immediate feedback (context update optional)
      ...
      <Card className="p-6 mb-8 shadow-card">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <div className="text-sm text-gray-600">Role: <span className="font-medium">Admin</span></div>
        ...
        {showPasswordForm && (
          <form className="bg-gray-50 border p-4 rounded-lg mt-3 space-y-2" onSubmit={handlePasswordChange}>
            <div>
